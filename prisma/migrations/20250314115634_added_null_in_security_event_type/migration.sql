...
*/
-- CreateEnum
CREATE TYPE "SecurityEventType" AS ENUM ('ACCOUNT_VERIFICATION', 'FAILED_LOGIN_ATTEMPT', 'PASSWORD_RESET', 'MFA_ENABLED', 'SUSPICIOUS_ACTIVITY', 'PROFILE_UPDATE', 'ASSET_TRANSFER', 'LOAN_APPLICATION', 'SIGNUP_INITIATED', 'NULL');
